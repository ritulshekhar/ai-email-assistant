...
// Inject badge into Gmail header
async function injectBadge(category) {
  try {
    ...
    console.warn("Could not inject badge:", err);
  }
}
...
// Observe Gmail route changes
const observer = new MutationObserver(() => {
  if (window.location.hash.includes("#inbox") || window.location.hash.includes("#all")) {
    handleEmailOpen();
  }
});
